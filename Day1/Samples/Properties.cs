...
namespace Properties
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            porsche.Horses = 200;
            Console.WriteLine("Value of the horse power: {0}", porsche.Horses);

            //Reset to 0 (this should not work - value should still be 200)
            //Reason - we have put some validations around the set property.
            porsche.Horses = 0;
    ...
    class Car
    {
        ...
        public int Horses
        {
            ...
            set
            {
                ...
                //Basic Idea - To Put Validations before actually assigning value
                if (value > 0)
                {
                        horses = value;
                }
